 ...
 * so a colleague can scan it straight off this screen instead of her
 * printed card (e.g. an Invoice Matcher at /invoices/assign). `/me` already
 * backs the header (Layout.tsx) app-wide, so this reuses that instead of a
 * new endpoint.
 */
export function AboutMePage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-black">{t('nav.about_me')}</h1>
      ...
      <Card>
        <dl className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-2 text-base">
          ...
          <dd className="font-semibold">
            {t(`roles.${me.role}`, { defaultValue: me.role_label })}
          </dd>
