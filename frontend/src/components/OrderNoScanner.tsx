      ...
      {(phase === 'review' || phase === 'nocamera') && (
        <div className="space-y-3">
          ...
          <input
            ...
            // No placeholder at all, deliberately: any example value here —
            // even one made of Xs — is still a hardcoded string sitting in
            // the box, and the previous one ("CP002458380_0001") happened to
            // be this exact test invoice's actual correct value, making an
            // empty field visually identical to a correctly-filled one. The
            // label above already says what to type; an empty box now only
            // ever means empty.
            value={value}
